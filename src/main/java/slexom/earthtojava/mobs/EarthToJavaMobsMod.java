...
public class EarthToJavaMobsMod {
    ...
    private static void registerEntitiesSpawn() {
        ...
        registerAnimalEntitySpawn(EntityTypesInit.PINK_FOOTED_PIG_REGISTRY_OBJECT.get(), E2JModConfig.pinkFootedPigSpawnBiomes.toArray(new String[0]), E2JModConfig.pinkFootedPigWeight, E2JModConfig.pinkFootedPigGroupMin, E2JModConfig.pinkFootedPigGroupMax);
