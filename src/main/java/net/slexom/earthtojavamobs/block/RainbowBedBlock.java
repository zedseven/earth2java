...
public class RainbowBedBlock extends HorizontalBlock implements ITileEntityProvider {
    ...
    public RainbowBedBlock(Block.Properties properties) {
        super(properties);
    ...
    public static Direction func_220174_a(IBlockReader p_220174_0_, BlockPos p_220174_1_) {
        ...
        return blockstate.getBlock() instanceof RainbowBedBlock ? blockstate.get(HORIZONTAL_FACING) : null;
    }
    ...
    public TileEntity createNewTileEntity(IBlockReader worldIn) {
        return new BedTileEntity(DyeColor.WHITE);
    }
